...
// ObjectStorageUISpec defines the desired state of ObjectStorageUI.
type ObjectStorageUISpec struct {
...
// ObjectStorageUIStatus defines the observed state of ObjectStorageUI.
type ObjectStorageUIStatus struct {
	...
	// UIURL is the address of the provisioned object storage ui.
	// +optional
...
// ObjectStorageUI is the Schema for the ObjectStorageUI.
type ObjectStorageUI struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   ObjectStorageUISpec   `json:"spec,omitempty"`
	Status ObjectStorageUIStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ObjectStorageUIList contains a list of ObjectStorageUI.
type ObjectStorageUIList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ObjectStorageUI `json:"items"`
}
